// app/romaneios/novo/page.tsx - O ARQUIVO CORRETO
'use client';
...
export default function UploadRomaneioPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      alert(`Romaneio enviado com sucesso! O link para assinatura é: /assinar/${newRomaneio.signatureToken}`);
  ...
  return (
    <div className="flex justify-center p-4 sm:p-8 bg-gray-50 min-h-screen">
      {/* O resto do seu JSX do formulário aqui... */}
      <div className="w-full max-w-2xl">
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6 p-8 bg-white rounded-lg shadow-md border">
          <div>
            <label htmlFor="file-upload" className="block text-sm font-medium leading-6 text-gray-900">Arquivo PDF</label>
            <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
              <div className="text-center">
                ...
                <div className="mt-4 flex text-sm leading-6 text-gray-600">
                  <label htmlFor="file-upload" className="relative cursor-pointer rounded-md bg-white font-semibold text-osirnet-blue focus-within:outline-none focus-within:ring-2 focus-within:ring-osirnet-light-blue focus-within:ring-offset-2 hover:text-osirnet-light-blue">
