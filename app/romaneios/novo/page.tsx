...
export default function UploadRomaneioPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    // A LÓGICA DE UPLOAD VIRÁ AQUI NO PRÓXIMO PASSO
    console.log('Arquivo selecionado:', file.name);
    alert('Funcionalidade de upload ainda não implementada. Mas o arquivo foi capturado com sucesso!');
